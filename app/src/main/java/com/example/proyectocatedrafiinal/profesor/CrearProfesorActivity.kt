...
import com.example.proyectocatedrafiinal.Alumno.AlumnoApi
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /*
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            nombreEditText = findViewById(R.id.editTextNombre_profe)
            apellidoEditText = findViewById(R.id.editTextApellido_profe)
            edadEditText = findViewById(R.id.editTextEdad_profe)
